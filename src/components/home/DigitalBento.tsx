      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 reveal-up">
          ...
          <div className="mt-4 md:mt-0 relative w-full sm:w-72">
            <input
              ...
              className="w-full text-xs bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2.5 pl-9 focus:outline-none focus:ring-2 focus:ring-skagata-500 focus:bg-white transition shadow-sm text-slate-900 dark:text-white"
            />
        ...
        <div id="portalGrid" className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 w-full">
          {filteredPortals.map((portal) => {
            const Icon = portal.IconComponent;
            return (
