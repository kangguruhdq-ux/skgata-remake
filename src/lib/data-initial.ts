...
export const INITIAL_ARCHIVE_PHOTOS: ArchivePhoto[] = [
  ...
  {
    id: "arc-2",
    title: "Praktek Perbengkelan Bubut Logam Generasi Awal",
    caption: "Taruna generasi awal STM 2 Jetis mengoperasikan mesin bubut sabuk flat-belt buatan Eropa.",
    year: "Era 1975",
  ...
  {
    id: "arc-3",
    title: "Upacara Parade Korps Taruna Skagata",
    caption: "Tradisi parade kedisiplinan dan pengukuhan taruna tingkat I di Lapangan Utama Jetis.",
    year: "Era 2012",
  ...
  {
    id: "arc-4",
    title: "Kunjungan & Kemitraan Industri Manufaktur",
    caption: "Penandatanganan kerja sama magang dan rekrutmen teknisi industri nasional.",
    year: "Era 2018",
...
export const INITIAL_FACILITIES: FacilityItem[] = [
  {
    id: "fac-1",
    title: "CNC Machining Center & Fabrikasi Presisi",
    category: "Teknik Mesin",
    image: "https://smkn3jogja.sch.id/wp-content/uploads/2023/04/WhatsApp-Image-2023-04-06-at-11.56.52-576x1024.jpeg",
    desc: "Dilengkapi mesin CNC Milling 3-Axis & 5-Axis, CNC Turning, 40+ unit mesin bubut konvensional, frais universal, dan ruang simulasi CAD/CAM Mastercam.",
    equipment: ["CNC Milling 5-Axis", "CNC Turning Lathe", "EDM Wire Cut", "40 Mesin Bubut Konvensional"],
  },
  {
    id: "fac-2",
    title: "Studio TV & Audio Broadcast Skagata TV",
    category: "Broadcasting",
    image: "https://smkn3jogja.sch.id/wp-content/uploads/2023/04/BP-1024x740.jpeg",
    desc: "Studio kedap suara bertaraf broadcast profesional, Master Control Room (MCR), multi-camera system 4K, teleprompter, dan ruang editing Mac Workstation.",
    equipment: ["Studio Akustik Kedap Suara", "Blackmagic 4K Switcher", "Teleprompter 21 Inch", "Audio Mixer Digital Yamaha"],
  },
  {
    id: "fac-3",
    title: "Laboratorium Mikrotik Academy & Fiber Optik",
    category: "TJKT",
...
export const INITIAL_PROFILE: SchoolProfile = {
  ...
  missions: [
    "Menumbuhkembangkan keimanan, ketaqwaan, dan pembentukan karakter ketarunaan yang berintegritas tinggi.",
    "Menyelenggarakan pembelajaran berbasis kompetensi (CBT) dan Teaching Factory (TEFA) selaras dengan Standar Kebutuhan Dunia Kerja (IDUKA).",
    "Meningkatkan profesionalisme pendidik dan tenaga kependidikan bersertifikasi industri dan asesor BNSP.",
    "Mengembangkan jejaring kemitraan nasional dan internasional dalam penyaluran tenaga kerja vokasi berkualitas.",
    "Mewujudkan tata kelola sekolah yang transparan, akuntabel, dan berbasis teknologi informasi (Paperless Smart Campus).",
  ],
  goals: [
